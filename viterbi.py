...
class Viterbi:
        ...
        while not self.queue.empty():
            ...
            for successor in self.hmm.getSuccessors(state):
                if successor != state:
                    ...
                    self.optimal_path[successor][0] = state 
                    self.epsilon_path[successor][0] = True 
    ...
    def calc_alpha_hat(self):
        for t in range(1, self.seqLen):
            ...
            while not self.queue.empty():
                ...
                self.takeOptimalPath( t, state, tran_alpha_hat_list, tran_path_list, epsil_tran_alpha_hat_list, epsil_tran_path_list )
    ...
    def takeOptimalPath(self, t, state, tran_alpha_hat_list, tran_path_list, epsil_tran_alpha_hat_list, epsil_tran_path_list):
        ...
        #print t, state, tran_alpha_hat_list, epsil_tran_alpha_hat_list
    ...
    def getOptimalPath(self):
        ...
        while True:
            ...
            if self.epsilon_path[state][t] == True:
                ...
                if state == self.hmm.getInitialState():
                    break
            else:
